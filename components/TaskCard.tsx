    ...
    <div className="group bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-slate-100">
        ...
        <div className="flex gap-2">
          {nextAction && (
            <button 
              onClick={() => onStatusChange(task.id, { status: nextAction.status })}
              className="text-[10px] font-bold uppercase tracking-wide px-3 py-1 bg-blue-50 text-blue-600 rounded-full hover:bg-blue-600 hover:text-white transition-all flex items-center gap-1"
            >
          ...
          {task.status !== TaskStatus.DONE && (
            <button 
              ...
              className="text-[10px] font-bold uppercase tracking-wide px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full hover:bg-emerald-600 hover:text-white transition-all flex items-center gap-1"
            >
